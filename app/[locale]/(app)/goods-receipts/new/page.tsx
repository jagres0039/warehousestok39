...
import { GoodsReceiptForm } from "../../_transactions/forms";
...
export default async function NewGoodsReceiptPage({ params }: PageProps) {
  ...
  const [warehouses, suppliers, items] = await Promise.all([
  ...
  if (warehouses.length === 0 || items.length === 0) {
    return (
      <div className="mx-auto max-w-2xl space-y-4">
        <PageHeader title={t("receiptCreateTitle")} />
